...
export const experiences: {
...
}[] = [
  {
    ...
    status: "Completed",
    description:
      "Designed creative posters that won national-level recognition for visual storytelling.",
    category: "Design",
  },
  {
    ...
    status: "Active",
    description:
      "Designed end-to-end interfaces for a student management web platform with focus on accessibility.",
    category: "Design",
  },
  {
    ...
    status: "Active",
    description:
      "Producing visual & video content around tech, study journey, and creative tutorials.",
    category: "Content",
  },
  {
    ...
    status: "Completed",
    description:
      "Assisted students in subnetting, Cisco Packet Tracer labs, and basic network configuration.",
    category: "IT",
  },
];
...
export const certifications = [
  ...
  {
    title: "National Poster Award",
    issuer: "National Comp.",
    year: "2024",
...
export const projects: {
  ...
  {
    name: "UI_UX_Design.case",
    category: "UI/UX",
    year: "2024",
    stack: ["Figma", "React"],
    description: "Student dashboard concept with neon dark theme.",
  },
  {
    name: "Web_Development.project",
    category: "Web",
    year: "2024",
    stack: ["React", "Tailwind"],
    description: "Personal landing page with parallax & smooth animations.",
  },
  {
    name: "Graphic_Design.gallery",
    category: "Design",
    year: "2023",
    stack: ["Photoshop", "Illustrator"],
    description: "Curated poster & branding works.",
  },
  {
    name: "Video_Editing.reel",
    category: "Video",
    year: "2024",
    stack: ["Premiere", "CapCut"],
    description: "Short-form content reels for personal branding.",
  },
  {
    name: "Network_Config.lab",
    category: "Network",
    year: "2024",
    stack: ["Cisco PT"],
    description: "Subnetting & VLAN simulation labs.",
  },
  {
    name: "Java_App.exec",
    ...
    description: "Inventory desktop app with MySQL backend.",
  },
];
