  ...
  if (
    ...
    return (
      <svg
        ...
        strokeWidth="2"
        role="img"
        aria-label="National competition trophy"
      >
        ...
        <TerminalBox title="contact.sh" className="lg:row-span-2">
          ...
          <div className="mt-5 flex gap-3 text-muted-foreground">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Open Jay SZRS GitHub profile"
              title="GitHub"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Open Jay SZRS LinkedIn profile"
              title="LinkedIn"
              className="glass social-glass inline-flex size-10 items-center justify-center hover:text-neon transition"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Open Jay SZRS Instagram profile"
              title="Instagram"
              className="glass social-glass inline-flex size-10 items-center justify-center hover:text-neon transition"
            >
