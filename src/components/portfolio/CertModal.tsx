          ...
          >
            ...
            <div className="p-6 space-y-4">
              {cert.certificate_url ? (
                ...
                <div className="glass aspect-video rounded-2xl flex items-center justify-center font-mono text-muted-foreground">
              ...
              <div>
                ...
                {cert.description && (
                  <p className="mt-3 text-muted-foreground text-sm">{cert.description}</p>
                )}
              </div>
              <div className="flex flex-wrap gap-2 pt-2">
                ...
                {cert.verification_url && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener"
                    className="liquid-button inline-flex items-center gap-2 px-4 py-2 glass border border-border font-mono text-xs rounded-full"
                  >
